...
# Post-edit semantic judging follows CoVEBench's uniform temporal coverage
# independently of the five-frame prompt/reference protocol.
POST_EDIT_OBSERVER_FRAME_INDICES = (0, 12, 24, 35, 47, 59, 71, 82, 94, 106)
